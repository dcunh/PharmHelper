(function () {
    ...
    const cart = document.getElementsByClassName('js-cd-cart');
    if (cart.length > 0) {
        ...
        function initCartEvents() {
            ...
            cartUndo.addEventListener('click', function (event) {
                if (event.target.tagName.toLowerCase() === 'a') {
                    ...
                    const deletedProduct = cartList.getElementsByClassName('cd-cart__product--deleted')[0];
        ...
        function addToCart(event) {
            ...
            const cartIsEmpty = Util.hasClass(cart[0], 'cd-cart--empty');

            //update cart product list
            addProduct(getProductData(event.target.dataset.price));
        ...
        function addProduct(target) {
            ...
            if (target === 'BIO-OIL OLEO CORPORAL') {
                ...
                productAdded = '<li class="cd-cart__product">' +
                    ...
                    '<span class="cd-cart__price">20,50€</span><div class="cd-cart__actions"><a href="#0" class="cd-cart__delete-item">Delete</a><div class="cd-cart__quantity">' +
            ...
            } else if (target === 'GRIPONAL') {

                productAdded = '<li class="cd-cart__product" id="' + target + '">' +
                    '<div class="cd-cart__image"><a href="#0"><img src="/images/shop/produtos/griponal.png" alt="placeholder"></a></div><div class="cd-cart__details"><h3 class="truncate"><a href="#0">GRIPONAL</a></h3>' +
                    '<span class="cd-cart__price">9,00€</span><div class="cd-cart__actions"><a href="#0" class="cd-cart__delete-item">Delete</a><div class="cd-cart__quantity">' +
                    '<label for="cd-product-' + productId + '">Qty</label><span class="cd-cart__select"><select class="reset" id="cd-product-' + productId + '" name="quantity"><option value="1">1</option>' +
                    '<option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option>' +
                    '<option value="9">9</option></select><svg class="icon" viewBox="0 0 12 12"><polyline fill="none" stroke="currentColor" points="2,4 6,8 10,4 "/></svg></span></div></div></div></li>';
        ...
        function removeProduct(product) {
            ...
            const topPosition = product.offsetTop,
        ...
        function removePreviousProduct() { // definitively removed a product from the cart (undo not possible anymore)
            const deletedProduct = cartList.getElementsByClassName('cd-cart__product--deleted');
        ...
        function updateCartCount(emptyCart, quantity) {
            if (typeof quantity === 'undefined') {
                ...
                let actual = Number(cartCountItems[0].innerText) + quantity;
                let next = actual + 1;
